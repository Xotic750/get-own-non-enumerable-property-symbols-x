...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["getOwnNonEnumerablePropertySymbolsX"] = factory();
	else
		root["getOwnNonEnumerablePropertySymbolsX"] = factory();
})((function () {
  'use strict';
...
// CONCATENATED MODULE: ./dist/get-own-non-enumerable-property-symbols-x.esm.js
function get_own_non_enumerable_property_symbols_x_esm_newArrowCheck(innerThis, boundThis) { if (innerThis !== boundThis) { throw new TypeError("Cannot instantiate an arrow function"); } }
...
var get_own_non_enumerable_property_symbols_x_esm_getOwnNonEnumerablePropertySymbols = function getOwnNonEnumerablePropertySymbols(target) {
  var _this = this;

  var object = to_object_x_esm(target);
  return array_filter_x_esm(get_own_property_symbols_x_esm(object), function (symbol) {
    get_own_non_enumerable_property_symbols_x_esm_newArrowCheck(this, _this);

    return property_is_enumerable_x_esm(object, symbol) === false;
  }.bind(this));
};

/* harmony default export */ var get_own_non_enumerable_property_symbols_x_esm = __webpack_exports__["default"] = (get_own_non_enumerable_property_symbols_x_esm_getOwnNonEnumerablePropertySymbols);
...
//# sourceMappingURL=get-own-non-enumerable-property-symbols-x.js.map